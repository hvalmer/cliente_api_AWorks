package com.braincustom.distlog.api.exceptionhandler;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleEntidadeNãoEncontrada(EntidadeNaoEncontradaException ex, WebRequest request){
